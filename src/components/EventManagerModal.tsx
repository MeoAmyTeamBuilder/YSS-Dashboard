...
import { X, Zap, Calendar, ChevronRight } from 'lucide-react';
...
export const EventManagerModal = ({ isOpen, onClose, onOpenSignGH, onOpenCalendar }: EventManagerModalProps) => {
  const options = [
    { title: 'Manage Sign Top GH', icon: Zap, color: 'text-yellow-400', onClick: onOpenSignGH },
    { title: 'Manage Calendar', icon: Calendar, color: 'text-blue-400', onClick: onOpenCalendar },
  ];
